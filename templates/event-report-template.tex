...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{[Brief professional caption for first image]}
        \label{fig:img1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{[Brief professional caption for second image]}
        \label{fig:img2}
    \end{subfigure}

    \caption{Glimpses from the Event — Session Highlights}
    \label{fig:glimpses1}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{[Brief professional caption for third image]}
    \label{fig:img3}
\end{figure}
