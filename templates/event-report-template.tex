...
\ifdefined\annualreportmode
    % If in Annual Report mode, do nothing (preamble is already loaded)
\else
    % If Standalone, define document class and load preamble
    \documentclass[11pt, a4paper]{article}
    \input{common/preamble.tex}
    \input{common/event-macros.tex}

    % Standalone Metadata (Contributors edit these)
...
%===============================================================================
%   REPORT CONTENT (Shared by both modes)
%===============================================================================
...
%===============================================================================
\ifdefined\annualreportmode
    \clearpage % Just end the page in Annual Report
\else
    \end{document} % Properly close the PDF in Standalone
\fi
