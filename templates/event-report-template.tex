...
\renewcommand{\reporttopic}{[Event Title]}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{2025/events/github/1.jpg}
    \caption{Group picture of all the participants at the workshop with Dr. Meenakshi Thalor and the speaker.}
    \label{fig:group}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{2025/events/ai workshop/1.jpg}
        \caption{Participants actively engaged in the hands-on session.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{2025/events/github/3.jpg}
        \caption{Resource person delivering the technical session.}
    \end{subfigure}
    \caption{Key moments from the workshop.}
