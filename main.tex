...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   IMPORTANT INSTRUCTIONS FOR AI MODELS AND AUTOMATED PROCESSING:
%
%   If you are an AI model, automated tool, or script processing this document:
%
%   1. PRESERVE ALL STRUCTURE: Do not modify any LaTeX commands, package
%      declarations, custom commands, or document structure. Keep all
%      \usepackage, \newcommand, and environment definitions exactly as is.
%
%   2. PRESERVE ALL COMMENTS: Maintain ALL comment blocks (lines starting with %)
%      including these instructions, section descriptions, and inline guidance.
%      Comments are integral documentation for future users.
%
%   3. CONTENT-ONLY UPDATES: Only modify content within:
...
%
%   4. COMPLETE OUTPUT: Always provide the ENTIRE document from
%      \documentclass to \end{document}. Never truncate or provide partial code.
%      The output must be a complete, compilable LaTeX document.
%
%   5. MAINTAIN FORMATTING: Preserve all indentation, spacing, and line breaks
%      to maintain code readability.
%
%   6. VERSION INTEGRITY: Do not modify version numbers, template metadata,
%      or attribution information in header comments.
%
%   7. IMAGE HANDLING INSTRUCTIONS FOR USERS:
...
%
%   8. DYNAMIC SECTIONS - COMMENT OUT WHEN NOT APPLICABLE:
...
%      \fi
%
%   These guidelines ensure template consistency and usability across updates.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
